...
<div style="background: linear-gradient(to right, rgba(180, 213, 120, 0.8), rgba(180, 213, 120, 0.2)), url(fondo.png); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 15px; font-size: 12px; border-radius: 18px; font-family: inherit; margin-bottom: 20px;">
...
<!-- Código completo del embed de Instagram centrado -->
<div style="text-align: center; display: flex; justify-content: center; width: 100%; margin: 20px 0;">
<blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/reel/DN9Zmz2DNn6/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 0 auto; max-width:540px !important; min-width:auto !important; padding:16px; width:60% !important; width:-webkit-calc(100% - 2px); width:calc(100% - 2px); display:block;">
<div style="padding:16px;">
<a href="https://www.instagram.com/reel/DN9Zmz2DNn6/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank"> 
...
<a href="https://www.instagram.com/reel/DN9Zmz2DNn6/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">Una publicación compartida por UNJuTV (@unjutv)</a>
</p>
</div>
</blockquote>
</div>
