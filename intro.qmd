...
<div align='justify' style="background: linear-gradient(to right, rgba(173, 255, 47, 0.8), rgba(173, 255, 47, 0.2)); padding: 15px; font-size: 14px;border-radius: 18px; font-family: inherit;">
